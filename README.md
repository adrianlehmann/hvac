...
Marketing site for an HVAC contractor, built with React and Vite.
...
This repo is set up for a **static** Cloudflare Pages deploy of the site in `artifacts/hvac-website`.
...
| **Build output directory** | `artifacts/hvac-website/dist/public` |
...
| Path | Purpose |
|------|---------|
| `artifacts/hvac-website` | **Production static site** (deploy this) |
